...
import { useStyles } from './store-sign-up.styles';
...
const StoreSignUpPage = ({ storeSignUp }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        const res = storeSignUp({ name, description, location, contactNumber, history });
        console.log(res);
    };
...
export default connect(null, mapDispatchToProps)(StoreSignUpPage);
